...
class Batch(models.Model):
    ...
    bo_no = models.CharField(db_column='BO_NO', max_length=8, blank=True, null=True)  # Field name made lowercase.
    part_no = models.CharField(db_column='PART_NO', max_length=8, blank=True, null=True)  # Field name made lowercase.
...
class M13Shop(models.Model):
    ...
    m13_no = models.CharField(db_column='M13_NO', max_length=10, blank=True, null=True)  # Field name made lowercase.
    m13_date = models.DateField(db_column='M13_DATE', blank=True, null=True)  # Field name made lowercase.
    wo = models.CharField(db_column='WO', max_length=8, blank=True, null=True)  # Field name made lowercase.
    part_no = models.CharField(db_column='PART_NO', max_length=8, blank=True, null=True)  # Field name made lowercase.
...
class Mnp(models.Model):
    ...
    maint_area = models.CharField(db_column='MAINT_AREA', max_length=3, blank=True, null=True)  # Field name made lowercase.
...
class M5DOCnew(models.Model):   
    ...
    proReason       = models.CharField(db_column='PROBABLE REASON', max_length=100, blank=True, null=True)
...
class m18(models.Model):
    ...
    refNo           = models.CharField(db_column='REFNO', max_length=100, blank=True, null=True)  # Field name made lowercase.
    proReason       = models.CharField(db_column='PROBABLE REASON', max_length=100, blank=True, null=True)
...
class M15(models.Model):
    ...
    wo = models.CharField(max_length=8, blank=True, null=True)
    part_no = models.CharField(max_length=8, blank=True, null=True)
...
class exam_master(models.Model):
    exam_code=models.CharField(max_length=10, blank=True, null= True)
    prac_desc = models.CharField(max_length=500, blank=True, null= True)
    prac_max = models.CharField(max_length=5, blank=True, null= True)
    oral_desc = models.CharField(max_length=500, blank=True, null= True)
...
class MG5(models.Model):
    shop_sec = models.CharField(db_column='SHOP_SEC', max_length=10, blank=True, null=True)  # Field name made lowercase.
    staff_no = models.CharField(db_column='STAFF_NO', max_length=12, blank=True, null=True)  
    name = models.CharField(db_column='EMPLOYEE_NAME', max_length=30, blank=True, null=True)  # Field name made lowercase.
...
class logbook_record(models.Model):
    date=models.CharField(max_length=15, blank=True, null=True,default=0) 
    shop_sec=models.CharField(max_length=20, blank=True, null=True)  # Field name made lowercase.
    m_w_no = models.CharField(max_length=10, blank=True, null=True)
    workorderno = models.CharField(max_length=10, blank=True, null=True)
    shift = models.CharField(max_length=3, blank=True, null=True)
    timein = models.CharField(max_length=10, blank=True, null=True)
    timeout = models.CharField(max_length=10, blank=True, null=True)
    opnno = models.CharField(max_length=10, blank=True, null=True)
    opn_desc = models.CharField(max_length=500, blank=True, null=True)
    m5glsno = models.CharField(max_length=10, blank=True, null=True)
    staff_no = models.CharField(max_length=10, blank=True, null=True)
    staffname = models.CharField(max_length=200, blank=True, null=True)
    stafftype= models.CharField(max_length=2, blank=True, null=True)
    attandance = models.CharField(max_length=2, blank=True, null=True)    
    out_turn = models.CharField(max_length=10, blank=True, null=True)  
    flag = models.CharField(max_length=2, blank=True, null=True)  
    login_id=models.CharField(max_length=20, blank=True, null=True,default=0)  # Field name made lowercase.
    last_modified=models.CharField(max_length=60, blank=True, null=True,default=0)  # Field name made lowercase.

class M5SHEMP1(models.Model):
    # yymm = models.CharField(db_column='YYMM', max_length=4, blank=True, null=True)  # Field name made lowercase.
    shopsec = models.CharField(db_column='SHOPSEC', max_length=10, blank=True, null=True)  # Field name made lowercase.
    staff_no = models.CharField(db_column='STAFF_NO', max_length=50, blank=True, null=True)  # Field name made lowercase.
    name = models.CharField(db_column='NAME', max_length=40, blank=True, null=True)  # Field name made lowercase.
    ...
    # emp_type = models.CharField(db_column='EMP_TYPE', max_length=10, blank=True, null=True)  # Field name made lowercase.
    # status = models.CharField(db_column='STATUS', max_length=10, blank=True, null=True)  # Field name made lowercase.
    # remark = models.CharField(db_column='REMARK', max_len1000, blank=True, null=True)  # Field name made lowercase.
    # updt_by = models.CharField(db_column='UPDT_BY', max_length=20, blank=True, null=True)  # Field name made lowercase.
    # updt_date = models.CharField(db_column='UPDT_DATE',max_length=20, blank=True, null=True)  # Field name made lowercase.
    # rec_ind = models.CharField(db_column='REC_IND', max_length=10, blank=True, null=True)  # Field name made lowercase.
    ticket_no = models.CharField(db_column='TICKET_NO',max_length=20,  blank=True, null=True, default=0)  # Field name made lowercase.
...
class M12DOC1(models.Model):
    ...
    # rec_ind = models.CharField(db_column='REC_IND', max_length=10, blank=True, null=True)  # Field name made lowercase.
    # ticket_no = models.CharField(db_column='TICKET_NO',max_length=20,  blank=True, null=True, default=0)  # Field name made lowercase.
    month = models.CharField(db_column='MONTH', max_length=15, blank=True,null=True,default=0) # Field name made lowercase0.
    in1 = models.CharField(db_column='IN1', max_length=10, blank=True,null=True) # Field name made lowercase.
    out = models.CharField(db_column='OUT', max_length=10, blank=True,null=True) # Field name made lowercase.
    total_time = models.CharField(db_column='TOTAL_TIME',max_length=20, blank=True,null=True, default=0)
    idle_time = models.CharField(db_column='IDLE_TIME',max_length=20, blank=True,null=True, default=0)
    in_date = models.CharField(db_column='IN_DATE', max_length=10, blank=True,null=True) # Field name made lowercase.
    out_date = models.CharField(db_column='OUT_DATE', max_length=10, blank=True,null=True) # Field name made lowercase.
    shift_typename= models.CharField(db_column='SHIFT_TYPENAME',max_length=20, blank=True, null=True)
...
class MG21TAB(models.Model):
    shop_sec=models.CharField(db_column='shop_sec', max_length=30, blank=True, null=True,default=0)  # Field name made lowercase.
    ...
    resumedate=models.CharField(db_column='resumedate',max_length=20,blank=True,null=True)
    sse=models.CharField(db_column='sse', max_length=50, blank=True, null=True,default=0) 
    reportno=models.CharField(db_column='reportno',max_length=20,null=True)
    login_id = models.CharField(db_column='login_id',max_length=20, blank=True, null=True)
    current_date= models.CharField(db_column='current_date',max_length=20, blank=True, null=True)

    class Meta:
        db_table = 'MG21TAB'

class Intershop338(models.Model):
    shop_sec=models.CharField(db_column='SHOP_SEC', max_length=50, blank=True, null=True,default=0)  # Field name made lowercase.
    staffNo=models.CharField(db_column='STAFF_NO',max_length=20,primary_key=True)
    ...
    staffRate=models.CharField(db_column='STAFF_RATE',max_length=50,blank=True,null=True)
    toshop_sec=models.CharField(db_column='TOSHOP_SEC', max_length=50, blank=True, null=True,default=0) 
...
class Hwm5Inbox(models.Model):
    batch_no = models.CharField(db_column='BATCH_NO', max_length=50, blank=True, null=True)  # Field name made lowercase.
    assly_no = models.CharField(db_column='ASSLY_NO', max_length=50, blank=True, null=True)  # Field name made lowercase.
    part_no = models.CharField(db_column='PART_NO', max_length=50, blank=True, null=True)  # Field name made lowercase.
    des = models.CharField(db_column='DES', max_length=500, blank=True, null=True)  # Field name made lowercase.
    rm_partno = models.CharField(db_column='RM_PARTNO', max_length=50, blank=True, null=True)  # Field name made lowercase.
    rm_desc = models.CharField(db_column='RM_DESC', max_length=500, blank=True, null=True)  # Field name made lowercase.
    rm_ut = models.CharField(db_column='RM_UT', max_length=50, blank=True, null=True)  # Field name made lowercase.
    rm_qty = models.CharField(db_column='RM_QTY', max_length=50, blank=True, null=True)  # Field name made lowercase.
    shop_sec = models.CharField(db_column='SHOP_SEC', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lc_no = models.CharField(db_column='LC_NO', max_length=50, blank=True, null=True)  # Field name made lowercase.
    opn = models.CharField(db_column='OPN', max_length=50, blank=True, null=True)  # Field name made lowercase.
    opn_desc = models.CharField(db_column='OPN_DESC', max_length=500, blank=True, null=True)  # Field name made lowercase.
    opndesc = models.CharField(db_column='OPNDESC', max_length=500, blank=True, null=True)  # Field name made lowercase.
    pa = models.CharField(db_column='PA', max_length=50, blank=True, null=True)  # Field name made lowercase.
    at = models.CharField(db_column='AT', max_length=50, blank=True, null=True)  # Field name made lowercase.
    no_off = models.CharField(db_column='NO_OFF', max_length=50, blank=True, null=True)  # Field name made lowercase.
    qty_ord = models.CharField(db_column='QTY_ORD', max_length=50, blank=True, null=True)  # Field name made lowercase.
    l_fr = models.CharField(db_column='L_FR', max_length=50, blank=True, null=True)  # Field name made lowercase.
    l_to = models.CharField(db_column='L_TO', max_length=50, blank=True, null=True)  # Field name made lowercase.
    seq = models.CharField(db_column='SEQ', max_length=50, blank=True, null=True)  # Field name made lowercase.
    brn_no = models.CharField(db_column='BRN_NO', max_length=50,  blank=True, null=True)  # Field name made lowercase.
    scl_cl = models.CharField(db_column='SCL_CL', max_length=50, blank=True, null=True)  # Field name made lowercase.
    m2sln = models.CharField(db_column='M2SLN', max_length=50, blank=True, null=True)  # Field name made lowercase.
    m4_no = models.CharField(db_column='M4_NO', max_length=50, blank=True, null=True)  # Field name made lowercase.
    m5glsn = models.CharField(db_column='M5GLSN', max_length=50,  blank=True, null=True)  # Field name made lowercase.
    status = models.CharField(db_column='STATUS', max_length=50, blank=True, null=True)  # Field name made lowercase.
    pr_shopsec = models.CharField(db_column='PR_SHOPSEC', max_length=50, blank=True, null=True)  # Field name made lowercase.
    n_shopsec = models.CharField(db_column='N_SHOPSEC', max_length=50, blank=True, null=True)  # Field name made lowercase.
    hw_cd = models.CharField(db_column='HW_CD', max_length=2, blank=True, null=True)  # Field name made lowercase.
    epc = models.CharField(db_column='EPC', max_length=50, blank=True, null=True)  # Field name made lowercase.
    okcpm = models.CharField(db_column='OKCPM', max_length=50, blank=True, null=True)  # Field name made lowercase.
    okptc = models.CharField(db_column='OKPTC', max_length=50, blank=True, null=True)  # Field name made lowercase.
    okmrq = models.CharField(db_column='OKMRQ', max_length=50, blank=True, null=True)  # Field name made lowercase.
    okopn = models.CharField(db_column='OKOPN', max_length=50, blank=True, null=True)  # Field name made lowercase.
    oksslc = models.CharField(db_column='OKSSLC', max_length=50, blank=True, null=True)  # Field name made lowercase.
    okjbs = models.CharField(db_column='OKJBS', max_length=50, blank=True, null=True)  # Field name made lowercase.
    oksplit = models.CharField(db_column='OKSPLIT', max_length=50, blank=True, null=True)  # Field name made lowercase.
    sn = models.CharField(db_column='SN', max_length=50, blank=True, null=True)  # Field name made lowercase.
    time_pcpls = models.CharField(db_column='TIME_PCPLS', max_length=50,  blank=True, null=True)  # Field name made lowercase.
    tot_hrspls = models.CharField(db_column='TOT_HRSPLS', max_length=50, blank=True, null=True)  # Field name made lowercase.
    ib_no = models.CharField(db_column='IB_NO', max_length=50, blank=True, null=True)  # Field name made lowercase.
    sel_sw = models.CharField(db_column='SEL_SW', max_length=50, blank=True, null=True)  # Field name made lowercase.
    sel_sw_hod = models.CharField(db_column='SEL_SW_HOD', max_length=50, blank=True, null=True)  # Field name made lowercase.
    usr_cd = models.CharField(db_column='USR_CD', max_length=50, blank=True, null=True)  # Field name made lowercase.
    remarks = models.CharField(db_column='REMARKS', max_length=500, blank=True, null=True)  # Field name made lowercase.
    shopsecold = models.CharField(db_column='SHOPSECOLD', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lcnoold = models.CharField(db_column='LCNOOLD', max_length=50, blank=True, null=True)  # Field name made lowercase.
    print_ctrl = models.CharField(db_column='PRINT_CTRL', max_length=50, blank=True, null=True)  # Field name made lowercase.
    del_fl = models.CharField(db_column='DEL_FL', max_length=50, blank=True, null=True)  # Field name made lowercase.
    m13_no = models.CharField(db_column='M13_NO', max_length=50, blank=True, null=True)  # Field name made lowercase.
    org_batch = models.CharField(db_column='ORG_BATCH', max_length=50, blank=True, null=True)  # Field name made lowercase.
    org_brnno = models.CharField(db_column='ORG_BRNNO', max_length=50, blank=True, null=True)  # Field name made lowercase.
    plregno = models.CharField(db_column='PLREGNO', max_length=50, blank=True, null=True)  # Field name made lowercase.
    ...
    cardstatus = models.CharField(db_column='CARD_STATUS', max_length=2, blank=True, null=True)  # Field name made lowercase.
...
class roster1(models.Model):
    ...
    stafftype=models.CharField(db_column='stafftype',max_length=2,blank=True,null=True)
...
class Tempm14M4(models.Model):
    doc_code = models.CharField(db_column='DOC_CODE', max_length=2, blank=True, null=True)  # Field name made lowercase.
    doc_no = models.DecimalField(db_column='DOC_NO', max_digits=10, decimal_places=0, blank=True, null=True)  # Field name made lowercase.
    rm_part = models.CharField(db_column='RM_PART', max_length=8, blank=True, null=True)  # Field name made lowercase.
    pm_no = models.CharField(db_column='PM_NO', max_length=5, blank=True, null=True)  # Field name made lowercase.
    part_no = models.CharField(db_column='PART_NO', max_length=8, blank=True, null=True)  # Field name made lowercase.
    qty = models.DecimalField(db_column='QTY', max_digits=8, decimal_places=3, blank=True, null=True)  # Field name made lowercase.
    ...
    bo_no = models.CharField(db_column='BO_NO', max_length=8, blank=True, null=True)  # Field name made lowercase.
    assly_no = models.CharField(db_column='ASSLY_NO', max_length=8, blank=True, null=True)  # Field name made lowercase.
    seq = models.DecimalField(db_column='SEQ', max_digits=8, decimal_places=3, blank=True, null=True)  # Field name made lowercase.
    due_wk = models.CharField(db_column='DUE_WK', max_length=4, blank=True, null=True)  # Field name made lowercase.
    brn_no = models.DecimalField(db_column='BRN_NO', max_digits=8, decimal_places=3, blank=True, null=True)  # Field name made lowercase.
    doc_ind = models.CharField(db_column='DOC_IND', max_length=1, blank=True, null=True)  # Field name made lowercase.
    unit = models.CharField(db_column='UNIT', max_length=2, blank=True, null=True)  # Field name made lowercase.
    epc = models.CharField(db_column='EPC', max_length=2, blank=True, null=True)  # Field name made lowercase.
...
class Tempm14M4new(models.Model):
    doc_code = models.CharField(db_column='DOC_CODE', max_length=2, blank=True, null=True)  # Field name made lowercase.
    doc_no = models.DecimalField(db_column='DOC_NO', max_digits=10, decimal_places=0, blank=True, null=True)  # Field name made lowercase.
    rm_part = models.CharField(db_column='RM_PART', max_length=8, blank=True, null=True)  # Field name made lowercase.
    pm_no = models.CharField(db_column='PM_NO', max_length=5, blank=True, null=True)  # Field name made lowercase.
    ...
    seq = models.DecimalField(db_column='SEQ', max_digits=8, decimal_places=3, blank=True, null=True)  # Field name made lowercase.
    due_wk = models.CharField(db_column='DUE_WK', max_length=4, blank=True, null=True)  # Field name made lowercase.
    brn_no = models.DecimalField(db_column='BRN_NO', max_digits=8, decimal_places=0, blank=True, null=True)  # Field name made lowercase.
    doc_ind = models.CharField(db_column='DOC_IND', max_length=1, blank=True, null=True)  # Field name made lowercase.
    unit = models.CharField(db_column='UNIT', max_length=2, blank=True, null=True)  # Field name made lowercase.
    epc = models.CharField(db_column='EPC', max_length=2, blank=True, null=True)  # Field name made lowercase.

class TempM5Docnew(models.Model):
    scl_cl = models.CharField(db_column='SCL_CL', max_length=1, blank=True, null=True)  # Field name made lowercase.
    batch_no = models.CharField(db_column='BATCH_NO', max_length=8, blank=True, null=True)  # Field name made lowercase.
    assly_no = models.CharField(db_column='ASSLY_NO', max_length=8, blank=True, null=True)  # Field name made lowercase.
    part_no = models.CharField(db_column='PART_NO', max_length=8, blank=True, null=True)  # Field name made lowercase.
...
class logbook_work_desc(models.Model):
    id=models.AutoField(primary_key=True)
    work_type=models.CharField(max_length=20)
    Work_desc =models.CharField(max_length=200)
    Shop_code = models.CharField(max_length=5)
    
class m13tmp2(models.Model):
    bo_no = models.CharField(db_column='BO_NO', max_length=7, blank=True, null=True)  # Field name made lowercase.
    part_no = models.CharField(db_column='PART_NO', max_length=8, blank=True, null=True)  # Field name made lowercase.
    ep_type = models.CharField(db_column='EP_TYPE', max_length=2, blank=True, null=True)  # Field name made lowercase.
    pm_no = models.CharField(db_column='PM_NO', max_length=4, blank=True, null=True)  # Field name made lowercase.
    org_batch = models.CharField(db_column='ORG_BATCH', max_length=7, blank=True, null=True)  # Field name made lowercase.
    brn_no = models.CharField(db_column='BRN_NO', max_length=8, blank=True, null=True)  # Field name made lowercase.
    batch_qty = models.CharField(db_column='BATCH_QTY', max_length=8, blank=True, null=True)  # Field name made lowercase.
    batch_type = models.CharField(db_column='BATCH_TYPE', max_length=1, blank=True, null=True)  # Field name made lowercase.
    seq = models.CharField(db_column='SEQ', max_length=3, blank=True, null=True)  # Field name made lowercase.
    loco_fr = models.CharField(db_column='LOCO_FR', max_length=4, blank=True, null=True)  # Field name made lowercase.
    loco_to = models.CharField(db_column='LOCO_TO', max_length=4, blank=True, null=True)  # Field name made lowercase.
    status = models.CharField(db_column='STATUS', max_length=1, blank=True, null=True)  # Field name made lowercase.
    b_expl_dt = models.CharField(db_column='B_EXPL_DT',max_length=10, blank=True, null=True)  # Field name made lowercase.
    bo_updt_dt = models.CharField(db_column='BO_UPDT_DT', max_length=10, blank=True, null=True)  # Field name made lowercase.
    ptc = models.CharField(db_column='PTC', max_length=1, blank=True, null=True)  # Field name made lowercase.
    remark = models.CharField(db_column='REMARK', max_length=3, blank=True, null=True)  # Field name made lowercase.
